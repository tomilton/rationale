 ...
 * @generated
 */
public class RationaleInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RationaleNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ArchitecturalRationaleEditPart.MODEL_ID));
		RationaleDiagramEditorUtil.runWizard(getShell(), wizard,
