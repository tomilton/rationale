...
import org.architectural.rationale.diagram.part.RationaleDiagramEditor;
 ...
 * @generated
 */
public class RationaleNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RationaleNavigatorItem) {
					selectedElement = ((RationaleNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ArchitecturalRationaleEditPart.MODEL_ID
							.equals(RationaleVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RationaleDiagramEditor.ID);
