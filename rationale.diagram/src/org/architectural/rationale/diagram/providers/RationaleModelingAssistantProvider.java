 ...
 * @generated
 */
public class RationaleModelingAssistantProvider extends
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog.setMessage(Messages.RationaleModelingAssistantProviderMessage);
		dialog.setTitle(Messages.RationaleModelingAssistantProviderTitle);
