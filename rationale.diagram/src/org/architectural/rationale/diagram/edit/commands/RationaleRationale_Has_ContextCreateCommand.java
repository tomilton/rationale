 ...
 * @generated
 */
public class RationaleRationale_Has_ContextCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RationaleRationale_Has_ContextCreateCommand(
	...
	public boolean canExecute() {
		...
		return RationaleBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRationaleRationale_Has_Context_4002(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRationale_Has_Context(getTarget());
		}
