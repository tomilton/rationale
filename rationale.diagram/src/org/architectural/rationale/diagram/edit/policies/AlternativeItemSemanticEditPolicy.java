 ...
 * @generated
 */
public class AlternativeItemSemanticEditPolicy extends
		RationaleBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AlternativeItemSemanticEditPolicy() {
		super(RationaleElementTypes.Alternative_2005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RationaleVisualIDRegistry.getVisualID(incomingLink) == RationaleRationale_Has_AlternativeEditPart.VISUAL_ID) {
