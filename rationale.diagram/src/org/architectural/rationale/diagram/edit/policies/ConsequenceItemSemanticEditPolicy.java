 ...
 * @generated
 */
public class ConsequenceItemSemanticEditPolicy extends
		RationaleBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ConsequenceItemSemanticEditPolicy() {
		super(RationaleElementTypes.Consequence_2009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RationaleVisualIDRegistry.getVisualID(incomingLink) == RationaleRationale_Has_ConsequenceEditPart.VISUAL_ID) {
