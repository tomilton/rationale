 ...
 * @generated
 */
public class ArchitecturalTacticItemSemanticEditPolicy extends
		RationaleBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ArchitecturalTacticItemSemanticEditPolicy() {
		super(RationaleElementTypes.ArchitecturalTactic_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RationaleVisualIDRegistry.getVisualID(incomingLink) == ArchitecturalDecisionArchitecturalDecision_Has_ArchitecturalTacticEditPart.VISUAL_ID) {
