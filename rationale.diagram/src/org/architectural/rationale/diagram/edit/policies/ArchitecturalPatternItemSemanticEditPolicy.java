 ...
 * @generated
 */
public class ArchitecturalPatternItemSemanticEditPolicy extends
		RationaleBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ArchitecturalPatternItemSemanticEditPolicy() {
		super(RationaleElementTypes.ArchitecturalPattern_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RationaleVisualIDRegistry.getVisualID(incomingLink) == ArchitecturalDecisionArchitecturalDecision_Has_ArchitecturalPatternEditPart.VISUAL_ID) {
