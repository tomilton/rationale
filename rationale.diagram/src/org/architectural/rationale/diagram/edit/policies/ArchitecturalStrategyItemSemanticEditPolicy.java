 ...
 * @generated
 */
public class ArchitecturalStrategyItemSemanticEditPolicy extends
		RationaleBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ArchitecturalStrategyItemSemanticEditPolicy() {
		super(RationaleElementTypes.ArchitecturalStrategy_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (RationaleVisualIDRegistry.getVisualID(incomingLink) == ArchitecturalDecisionArchitecturalDecision_Has_ArchitecturalStrategyEditPart.VISUAL_ID) {
