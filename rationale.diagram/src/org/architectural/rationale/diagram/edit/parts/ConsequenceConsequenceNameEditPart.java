 ...
 * @generated
 */
public class ConsequenceConsequenceNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConsequenceConsequenceNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ConsequenceConsequenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
