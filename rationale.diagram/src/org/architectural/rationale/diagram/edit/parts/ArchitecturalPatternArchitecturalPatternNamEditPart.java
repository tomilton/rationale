 ...
 * @generated
 */
public class ArchitecturalPatternArchitecturalPatternNamEditPart extends
	 ...
	 * @generated
	 */
	public ArchitecturalPatternArchitecturalPatternNamEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ArchitecturalPatternArchitecturalPatternNamEditPart.VISUAL_ID));
		}
		return parser;
	}
