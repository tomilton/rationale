 ...
 * @generated
 */
public class ArchitecturalDecisionArchitecturalDecisionNaEditPart extends
	 ...
	 * @generated
	 */
	public ArchitecturalDecisionArchitecturalDecisionNaEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ArchitecturalDecisionArchitecturalDecisionNaEditPart.VISUAL_ID));
		}
		return parser;
	}
