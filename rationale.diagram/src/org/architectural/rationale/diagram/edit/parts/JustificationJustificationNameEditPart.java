 ...
 * @generated
 */
public class JustificationJustificationNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public JustificationJustificationNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.JustificationJustificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
