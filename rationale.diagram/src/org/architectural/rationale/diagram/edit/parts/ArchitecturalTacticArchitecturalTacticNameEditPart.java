 ...
 * @generated
 */
public class ArchitecturalTacticArchitecturalTacticNameEditPart extends
	 ...
	 * @generated
	 */
	public ArchitecturalTacticArchitecturalTacticNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ArchitecturalTacticArchitecturalTacticNameEditPart.VISUAL_ID));
		}
		return parser;
	}
