 ...
 * @generated
 */
public class AlternativeAlternativeNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AlternativeAlternativeNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.AlternativeAlternativeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
