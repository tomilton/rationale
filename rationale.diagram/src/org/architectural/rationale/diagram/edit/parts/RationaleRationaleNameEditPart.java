 ...
 * @generated
 */
public class RationaleRationaleNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public RationaleRationaleNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.RationaleRationaleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
