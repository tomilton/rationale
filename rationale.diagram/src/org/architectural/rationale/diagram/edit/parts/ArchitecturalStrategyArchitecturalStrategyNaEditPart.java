...
import org.architectural.rationale.diagram.edit.policies.RationaleTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ArchitecturalStrategyArchitecturalStrategyNaEditPart extends
	 ...
	 * @generated
	 */
	public ArchitecturalStrategyArchitecturalStrategyNaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RationaleTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return RationaleElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RationaleParserProvider
					.getParser(
							RationaleElementTypes.ArchitecturalStrategy_2003,
							getParserElement(),
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ArchitecturalStrategyArchitecturalStrategyNaEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					RationaleEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
