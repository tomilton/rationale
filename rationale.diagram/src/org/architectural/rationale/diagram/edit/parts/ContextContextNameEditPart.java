 ...
 * @generated
 */
public class ContextContextNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextContextNameEditPart(View view) {
		super(view);
	}
			...
			parser = RationaleParserProvider
					.getParser(
							...
							RationaleVisualIDRegistry
									.getType(org.architectural.rationale.diagram.edit.parts.ContextContextNameEditPart.VISUAL_ID));
		}
		return parser;
	}
