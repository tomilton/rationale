...
/**
 * This is the item provider adapter for a {@link org.architectural.rationale.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addContextDescriptionPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_ContextName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_ContextName_feature", "_UI_Context_type"),
				 RationalePackage.Literals.CONTEXT__CONTEXT_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Context Description feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addContextDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_ContextDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_ContextDescription_feature", "_UI_Context_type"),
				 RationalePackage.Literals.CONTEXT__CONTEXT_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Context)object).getContextName();
